...
const RecipeCard = ({
  ...
  const linkTo = `/recipe/${id}/${slug}`;

  return (
    <div
      className="card recipe-card bg-canvas h-100 border-0"
    ...
    >
      ...
      <div className="card-body pb-2">
        ...
        <p
          className="card-text text-charcoal small text-start"
          style={{ opacity: 0.8 }}
        >
          {description}
        </p>
      ...
      <div
        ...
        style={{
          borderTopWidth: "1px",
          borderTopColor: "rgba(68, 69, 68, 0.15)",
        }}
      >
        <div className="row text-center g-0">
          ...
          {/* Time */}
          <div
            className="col-4 d-flex flex-column align-items-center border-start border-end"
